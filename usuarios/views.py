...
def cadastro(request):
    if request.method == "GET":
        ...
        if len(senha) < 6:
            messages.add_message(request, constants.ERROR, 'A senha deve ter 7 ou mais dígitos')
            return redirect('/usuarios/cadastro')
        ...
        try:
            ...
            messages.add_message(request, constants.ERROR, 'Erro interno do servidor, contate um administrador')
            return redirect('/usuarios/cadastro')
